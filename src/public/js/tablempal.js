$(document).ready(function () {
    ...
    let codigo, nombpuesto, mesaspto, mesasreport, porc_report, totvot, totsuf, promedio, balance;
    var datoSet;
    var mCodigo;
    let table, tr, rowData;
  
    //Mostrar table
    let tablaMpal = $('#tab-mpal').DataTable({
      processing: true,
      ajax: {
        url: "/envios/tablapuestos/"+ myCodMpio,
        method: "GET",
        dataSrc: "",
      },
      rowId: "staffId",
    ...
    $(document).on("click", ".btnResult", function () {
      ...
      mNombPuesto = fila.find("td:eq(1)").text();
      ...
      $(".modal-title").text("Resultados de " + mNombPuesto);
    ...
    $(document).on("click", ".btnBuscar", function () {
      ...
      window.location.href = "/envios/verifypuesto/" + mCodigo;
    });
